...
from tc1_rc105_release_contract import candidate_metadata, replay_row_key


def amber_replay_row(tenant_id, route_id, delivery_id, payload, default_wait=180):
    raw = payload.get("retry_window", payload.get("retryWindow", default_wait)) or default_wait
