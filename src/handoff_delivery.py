...
class HandoffDeliveryLedger:
    def __init__(self) -> None:
        ...
        self._entries: dict[tuple[int, str], tuple[tuple[int, int], HandoffRecord | None]] = {}
        self._first_seen: dict[tuple[int, str], int] = {}
    ...
    def apply(self, events: Iterable[HandoffDeliveryEvent]) -> DeliverySnapshot:
        for event in events:
            ...
            entry_key = (event.producer_epoch, event.signal_id)
